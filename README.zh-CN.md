...
| 平台 | 下载文件 | 当前边界 |
|---|---|---|
| Windows x64 | `VRAMRadar-Setup-0.8.6.exe` | 按当前用户安装；目前未签名，SmartScreen 可能要求确认。 |
| macOS | `VRAMRadar-0.8.6-macos.zip` | 内含 Apple Silicon 与 Intel 两个原生应用；目前未签名、未公证，首次从 Finder 右击 **打开**。 |
...
Apple Silicon 当前验证边界为 macOS 14 或更新版本，Intel x86_64 为 macOS 15 或更新版本。请勿全局关闭 SmartScreen 或 Gatekeeper。详细边界见 [Windows 安装说明](docs/windows-install-and-update.md)、[Windows 签名状态](docs/windows-code-signing.md)、[macOS 兼容性说明](docs/macos-desktop.md)和 [v0.8.6 发布说明](docs/release-notes-v0.8.6.md)。
