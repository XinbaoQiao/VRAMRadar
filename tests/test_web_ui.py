...
class WebUiContractTests(unittest.TestCase):
    ...
    def test_account_home_and_lazy_directory_tree_are_progressively_disclosed(self):
        ...
        self.assertIn("details > summary", self.javascript)
        ...
        self.assertNotIn("window.setTimeout(pass, 80)", self.javascript)
        self.assertNotIn("window.setTimeout(pass, 180)", self.javascript)
